...
public class RemoveFirstStudentTest {
    ...
    public static void main(String[] args) {
		...
		String studentToDelete = driver.findElement(By.xpath("//*[@id=\"student-name\"]")).getText();
		String listOfCurrentStudents = driver.findElement(By.xpath("//*[@id=\"left\"]")).getText();
		
		//clicks on first student
		driver.findElement(By.xpath("//*[@id=\"student-name\"]")).click();
		...
		//checks if the list of students contains the student just removed and prints the result of the test
